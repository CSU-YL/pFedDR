...
# for pfeddr
def train_multitask(model, data_loader, optimizer, loss_fun, device, alpha=0.5, beta=2, ):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='../checkpoint/office_pfeddr',
    ...
    #  python pfeddr_office.py --log --mode pfeddr --unseen_client 3 --gpu 3
    ...
    log = args.log
    if log:
        log_path = os.path.join('../logs/office_pfeddr/', exp_folder)
    ...
    if args.test:
        ...
        # /home/liuyuan/liuyuan_home/project/FedBN/checkpoint/office_pfeddr/pfeddr_beta2
        checkpoint = torch.load(
            '../checkpoint/office_pfeddr/pfeddr_beta2/{}_seed{}_unseen{}'.format(args.mode.lower(), seed,
                                                                                    args.unseen_client))
    ...
    for a_iter in range(start_iter, args.iters):
        ...
        if best_changed:
            ...
            if args.mode.lower() == 'fedbn' or args.mode.lower() == 'pfeddr':
                torch.save({
