...
def aggregate(args, server_model, models, client_weights):
    with torch.no_grad():
        ...
        for key in server_model.state_dict().keys():
            ...
            elif 'bn6' in key or 'bn7' in key or 'fc' in key:
                # print(key)
                pass
            else:
        ...
        for client_idx in range(len(models)):
            for key in server_model.state_dict().keys():
                if 'bn6' in key or 'bn7' in key or 'fc' in key:
                    pass
                else:
...
if __name__ == '__main__':
    ...
    #  python dapfl_office.py --log --unseen_client 3 --gpu 3
    ...
    for a_iter in range(start_iter, args.iters):
        ...
        # aggregation
        server_model, pmodels = aggregate(args, server_model, pmodels, client_weights)
